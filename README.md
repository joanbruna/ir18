...
| 11 | 11/13 |  **Lec8** VI (cont'd) Variational Autoencoders [Slides](https://github.com/joanbruna/ir18/blob/master/slides/lecture8.pdf)  | [Fixing Max-Product: Convergent Message Passing Algorithms for MAP LP Relaxations, Globerson and Jaakkola](https://people.csail.mit.edu/tommi/papers/GloJaa_nips07.pdf) | |
